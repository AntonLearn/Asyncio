...
POSTGRES_USER = os.getenv("POSTGRES_USER", default="async")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", default="async")
POSTGRES_DB = os.getenv("POSTGRES_DB", default="async")
